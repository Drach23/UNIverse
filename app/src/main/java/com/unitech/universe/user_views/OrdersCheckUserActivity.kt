...
class OrdersCheckUserActivity : AppCompatActivity() {
    ...
    private lateinit var adapter: OrderCheckAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_orders_check_user)
        ...
        recyclerView = findViewById(R.id.recyclerView_user_orders)
        ...
        if (currentUser != null) {
            ...
            db.collection("pedidos")
                ...
                .addSnapshotListener { snapshots, exception ->
                    ...
                    adapter = OrderCheckAdapter(pedidosList)
